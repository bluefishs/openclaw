...
const MERGE_SUMMARIES_INSTRUCTIONS = [
  ...
  "Use the following structured sections (omit empty sections):",
  "",
  "## 使用者意圖",
  "The user's current goal and what they asked for.",
  "",
  "## 進行中任務",
  "Active tasks with status (in-progress, blocked, pending).",
  "Include batch progress (e.g., '5/17 items completed').",
  "",
  "## 技術上下文",
  "Key files, functions, APIs, and technical decisions relevant to current work.",
  "",
  "## 錯誤與修復",
  "Errors encountered and how they were resolved (or still open).",
  "",
  "## 決策與理由",
  "Decisions made and their rationale. Include constraints and trade-offs.",
  "",
  "## 待辦與下一步",
  "TODOs, open questions, commitments, and follow-ups promised.",
  "",
