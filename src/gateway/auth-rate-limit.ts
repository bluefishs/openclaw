 ...
 *   growth.
 * - NOTE: State is lost on process restart. For horizontal scaling (multiple
 *   gateway instances), migrate to Redis ZSET sliding window. See
 *   CK_NemoClaw/docs/ARCHITECTURE_REVIEW_2026-03-25.md §H-1.
