...
export class OpenClawApp extends LitElement {
  ...
  @state() workflowInstances: WorkflowInstanceView[] = [];
  @state() workflowEvents: WorkflowEvent[] = [];
  @state() workflowDefinitions: Array<{ id: string; name: string; stepCount: number }> = [];
  @state() workflowConnected = false;
  workflowSseController: import("./controllers/workflow-sse.ts").WorkflowSseController | null =
    null;
